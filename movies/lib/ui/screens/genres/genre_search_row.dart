...
class GenreSearchRow extends ConsumerStatefulWidget {
  ...
  const GenreSearchRow(this.onSearch,
      {this.initialSearchText = '', super.key});
...
class _GenreSearchRowState extends ConsumerState<GenreSearchRow> {
  ...
  void initState() {
    super.initState();
    movieTextController = TextEditingController(text: widget.initialSearchText);
  }
  ...
  void didUpdateWidget(covariant GenreSearchRow oldWidget) {
    ...
    if (oldWidget.initialSearchText != widget.initialSearchText) {
      movieTextController.text = widget.initialSearchText;
    }
  }
